...
/datum/techweb_node/genetics /// Pulsar 15/08/2024
	id = "genetics"
	display_name = "Genetics"
	description = "Understand and manipulate the power of DNA at your own will."
	prereq_ids = list("adv_biotech")
	design_ids = list("clonepod", "clonescanner", "cloning", "scan_consolenew")
...
/datum/techweb_node/adv_engi
	...
	design_ids = list("engine_goggles", "magboots", "forcefield_projector", "weldingmask", "rcd_loaded", "rpd_loaded", "sheetifier", "double_oxygen_tank")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
/datum/techweb_node/adv_mining
	...
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
// WS Edit Start - Yeet The BSM // Well fuck you *unyeets the BSM* - Pulsar 20/08/2024 Unfucked syntax - CFW 24.08.20
/datum/techweb_node/bluespace_mining
 	...
 	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 10000)
 	export_price = 5000
//  WS Edit End - Yeet The BSM // Cry about it WS. - Pulsar
...
// 24.08.17 - CFW - Added Basic and Advanced energy weapons

/datum/techweb_node/energy_weapons
	id = "energy_weapons"
	display_name = "Energy Weapon Technology"
	description = "An assortment of basic energy weapons."
	prereq_ids = list("weaponry")
	design_ids = list("e_gun", "e_gun_smg", "e_gun_mini", "kalix_pgf_heavy", "kalix_pgf_heavy_sniper")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000

/datum/techweb_node/adv_energy_weapons
	id = "adv_energy_weapons"
	display_name = "Advanced Energy Weapon Technology"
	description = "An assortment of enhanced energy weapons."
	prereq_ids = list("adv_weaponry", "energy_weapons")
	design_ids = list("e_gun_hades", "laser_scatter")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
/datum/techweb_node/electric_weapons
	...
	design_ids = list("stunrevolver", "ioncarbine", "ionrifle") // 24.08.17 - CFW - Added Ion Rifle
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
*/
////////////////////////Alien technology////////////////////////
/datum/techweb_node/alientech //AYYYYYYYYLMAOO tech /// Pulsar 15/08/2024
	id = "alientech"
	...
	/obj/item/weldingtool/abductor, /obj/item/wirecutters/abductor, /obj/item/circuitboard/machine/abductor, /obj/item/melee/baton/abductor, /obj/item/abductor, /obj/item/gun/energy/shrink_ray, /obj/item/research_notes/loot/genius)
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
	export_price = 20000
	hidden = TRUE
	design_ids = list("alienalloy")

/datum/techweb_node/alien_bio /// Pulsar 15/08/2024
	id = "alien_bio"
...
/datum/techweb_node/alien_engi /// Pulsar 15/08/2024
	id = "alien_engi"
	...
	/obj/item/gun/energy/shrink_ray, /obj/item/research_notes/loot/genius)
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 20000
	hidden = TRUE
