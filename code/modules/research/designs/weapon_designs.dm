...
/datum/design/ioncarbine
	name = "Ion Carbine"
	desc = "How to dismantle a cyborg : The carbine."
	id = "ioncarbine"
	build_type = PROTOLATHE
...
// 24.08.17 - CFW - Ion Rifle

/datum/design/ionrifle
	name = "Ion Rifle"
	desc = "How to dismantle a cyborg : The rifle."
	id = "ionrifle"
	build_type = PROTOLATHE
	materials = list(/datum/material/silver = 6600, /datum/material/iron = 8800, /datum/material/uranium = 2200)
...
// 24.08.17 - CFW - Energy Guns, Basic
...
/datum/design/e_gun/smg
	name = "Energy SMG"
	id = "e_gun_smg"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 7500, /datum/material/glass = 1500, /datum/material/titanium = 750)
...
/datum/design/e_gun/mini
	...
	id = "e_gun_mini"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 5000, /datum/material/glass = 1000, /datum/material/titanium = 500)
	build_path = /obj/item/gun/energy/e_gun/mini
	category = list("Weapons")
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY

/datum/design/kalix/pgf/heavy
	name = "HBG-7"
	id = "kalix_pgf_heavy"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 12500, /datum/material/glass = 2500, /datum/material/titanium = 1250)
	build_path = /obj/item/gun/energy/kalix/pgf/heavy
	category = list("Weapons")
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY

/datum/design/kalix/pgf/heavy/sniper
	name = "HBG-7L"
	id = "kalix_pgf_heavy_sniper"
	build_type = PROTOLATHE
...
// CFW - Energy Guns, Advanced

/datum/design/e_gun/hades
	name = "Hades Energy Rifle"
	id = "e_gun_hades"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 15000, /datum/material/glass = 3000, /datum/material/titanium = 1500)
